// Computed ROBDD
// ROBDD used for creation from the apply operation
// This ROBDD is specifically computed from two boolean expressions using
// the apply method. 
...
public class ROBDDComputed{
    ...
    private int app(int l,int h){
        int u;
        if(G[l][h] != -1){ 
         //   System.out.println("Returned 1" + String.valueOf(l) + String.valueOf(h));
            return G[l][h];
        }else if( ((l==0)||(l==1)) && ((h==0)||(h==1)) ) {
            
            
           // System.out.println("Returned 2" + String.valueOf(l) + String.valueOf(h));
            u = eval(String.valueOf(l) + op + String.valueOf(h))?1:0;
        }else if(T1[l][0] == T2[h][0]){
            
           // System.out.println("Returned 3" + String.valueOf(l) + String.valueOf(h));
            u = mk(T1[l][0], app(T1[l][1],T2[h][1]) , app(T1[l][2],T2[h][2]));
        }else if(T1[l][0] < T2[h][0]){
        
            
           // System.out.println("Returned 4" + String.valueOf(l) + String.valueOf(h));
            u = mk(T1[l][0], app(T1[l][1],h), app(T1[l][2],h) );
        }else{
        
            
          //  System.out.println("Returned 5" + String.valueOf(l) + String.valueOf(h));
    ...
    public static void main(String[] args){
        System.out.println("Hello. Program to demonstrate ROBDDComputed implementation");
